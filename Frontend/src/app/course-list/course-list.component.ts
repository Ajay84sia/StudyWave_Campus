    ...
    this.courseService
      ...
      .subscribe(
        (response) => {
          ...
          this.toast.info({detail:"Update",summary:'Course data updated Successfully',sticky:true, position: 'botomCenter'});
        },
        (error) => {
    ...
    if (confirm('Are you sure you want to delete this course?')) {
      this.courseService.deleteCourse(courseID).subscribe(
        (response) => {
          ...
          this.toast.warning({detail:"Delete",summary:'Course deleted Successfully',sticky:true, position: 'botomCenter'});
          this.courseService.getCourses().subscribe((data) => {
            this.courses = data;
          });
        },
